                ...
                <table id="imports_detail_table" class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody id='import-detail' class="table-body bg-white divide-y divide-gray-200">
                        <tr class="detail-row">
                            ...
                            <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
                                <input name='amount[]' type="number" min=1 value=1 class="pl-2 bg-slate-100 outline-transparent block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6" />
                            </td>
                            <td>
